...
$args = array('posts_per_page' => 6, 'paged' => $paged, 'category_name'=> $categoryname  );
                        ...
                        <div class="category-wrapper_all">
                            ...
                            <div class="new-cat-post" id="post-<?php the_ID(); ?>">
                                    ...
                                    <div class="body">
                                        ...
                                        ?>
										<br>
                                        <a href="<?php echo get_permalink(); ?>" style="font-weight:bold;float:right;" class="<?php foreach( get_the_category() as $cat ) { echo $cat->slug . '  '; } ?> ">Read More</a>
                                    </div>
