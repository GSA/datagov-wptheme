...
?>
<form role="search" method="get" class="search-form form-inline<?php if(is_front_page()): ?> no-padding col-md-12 col-lg-12<?php else:?> navbar-right navbar-nav  col-sm-6 col-md-6 col-lg-6<?php endif;?>" action="<?php echo $protocol.$ckan_default_server ?>">
