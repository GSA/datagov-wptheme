<form role="search" method="get" class="search-form form-inline <?php if(is_front_page()): ?>col-md-7 col-lg-7 pull-right<?php else: ?>col-md-5 col-lg-5<?php endif;?>" action="<?php echo home_url('/'); ?>">
