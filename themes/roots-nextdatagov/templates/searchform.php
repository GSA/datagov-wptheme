<form role="search" method="get" class="search-form form-inline <?php if(is_front_page()): ?>col-md-12 col-lg-12<?php else: ?>col-md-6 col-lg-6<?php endif;?>" action="<?php echo home_url('/'); ?>">
