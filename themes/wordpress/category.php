...
<body class="<?php echo get_category_by_slug($slug)->name;  ?>">
...
<div class="<?php echo get_category_by_slug($slug)->name;  ?>_outer community_box">
                ...
                <?php if (get_post_format() == 'status'): ?>
                    ...
                    <div class="post small tweet">
                        ...
                        <div class="meta">
                            ...
                            <div class="corner <?php echo get_category_by_slug($slug)->name; ?>">
                                <div class="block"></div>
                                <div class="topic">
                                    <?php
                                    //$slug = $wp_query->query_vars['category_name'];
