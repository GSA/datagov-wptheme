...
function roots_scripts() {
	...
	wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '1427d8a0237d89ec37973b2fe37b4b0d');
	...
	if ( ! is_admin() && current_theme_supports( 'jquery-cdn' ) ) {
		...
		wp_register_script( 'jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js', false, null, false );
