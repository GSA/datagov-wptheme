...
function roots_scripts() {
	...
	wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '2a04825579377e58da5e4dacd2dbf8f1');
	...
	wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', false, 'cd18ede214bd719147d091e5b555b254', true );
