...
$all_agencies = array(
    ...
    'Education' => array('Education', 'education_id', 'education_class'),
    'Local Government' => array('Local Government', 'local_government_id', 'local_government_class'),
    'Non-Profit' => array('Non-Profit', 'non-profit_id', 'non-profit_class'),
    'Other Non-Federal' => array('NonFed-O', 'nonfed-o_id', 'nonfed-o_class'),
    'Private' => array('Private', 'private_id', 'private_class'),
    'Regional' => array('Regional', 'regional_id', 'regional_class'),
