    ...
    class ccf_recaptcha_field
    {
        ...
        function __construct($public_key, $label = null, $slug = null, $class = null, $initial_value = null, $field_instructions = null)
        {
            ...
            <div id="recaptcha_widget" style="display:none" class="<?php echo esc_attr($class_attr); ?>">
                <div class="right">
                    <img class="logo" width="75" height="80"
                         src="<?php echo plugins_url(); ?>/custom-contact-forms/images/recaptcha-logo-white.png"/>

                    <div class="reload"><a href="javascript:Recaptcha.reload()"><img width="25" height="18"
                                                                                     src="<?php echo plugins_url(); ?>/custom-contact-forms/images/refresh.png"
                                                                                     alt="Reload captcha"/></a></div>
                    <div class="recaptcha_only_if_image audio"><a href="javascript:Recaptcha.switch_type('audio')"><img
                                width="25" height="15"
                                src="<?php echo plugins_url(); ?>/custom-contact-forms/images/audio.png"
                                alt="Play audio captcha"/></a></div>
					...
					-->
                    <div class="help"><a href="javascript:Recaptcha.showhelp()"><img width="25" height="16"
                                                                                     src="<?php echo plugins_url(); ?>/custom-contact-forms/images/help.png"
                                                                                     alt="Recaptcha help"/></a></div>
                </div>
                <div class="left">
                    <div id="recaptcha_image"></div>
                    <div class="recaptcha_only_if_incorrect_sol" style="color:red">Incorrect please try again</div>
                    <?php echo $label; ?>
                    <input value="<?php if (!empty($initial_value)) echo esc_attr($initial_value); ?>" type="text"
                           id="recaptcha_response_field" name="recaptcha_response_field"
                           class="<?php echo $tooltip_class; ?>" <?php echo $instructions_attr; ?> />
                </div>
