...
if (!class_exists('CustomContactFormsWidget')) {
    class CustomContactFormsWidget extends WP_Widget
    {
        ...
        function form($instance)
        {
            ...
            <p><label for="<?php echo $this->get_field_id('form_id'); ?>">
                    ...
                    <select id="<?php echo $this->get_field_id('form_id'); ?>"
                        ...
                        foreach ($forms as $form) {
                            ?>
                            <option <?php if ($form_id == $form->id) echo 'selected="selected"' ?>
                                value="<?php echo $form->id; ?>"><?php echo $form->form_slug; ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <p>
                <a href="options-general.php?page=custom-contact-forms#forms"><?php _e('Create a Form', 'custom-contact-forms'); ?></a>
            </p>
        <?php
        }
    }
