            ...
            <table id="ccf-dashboard" cellpadding="0" cellspacing="0">
                ...
                foreach ($user_data_array as $data_object) {
                    ...
                    <tr class="<?php if ($i % 2 == 1) echo 'even'; ?>">
                        ...
                        <td>
                            <input class="ccf-view-submission" type="button"
                                   value="<?php _e('View', 'custom-contact-forms'); ?>"/>

                            <div class="ccf-view-submission-popover"
                                 title="<?php _e('CCF Saved Form Submission', 'custom-contact-forms'); ?>">
                                <div class="top">
                                    <div class="left">
                                        <p><?php _e('Form Submitted:', 'custom-contact-forms'); ?>
                                            <span><?php echo ($this_form == '-') ? __('Not Found', 'custom-contact-forms') : $this_form; ?></span>
                                        </p>
                                ...
                                ?></span></p></div>
                                    <div class="right">
                                        <span><?php echo date('F j, Y, g:i a', $data->getDataTime()); ?></span></div>
                                </div>
                                ...
                                <div class="separate"></div>
                                <a class="button"
                                   href="admin.php?page=ccf-saved-form-submissions"><?php _e('View All Submissions', 'custom-contact-forms'); ?></a>
                            </div>
                        </td>
                    </tr>
                    <?php
