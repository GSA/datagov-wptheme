...
jQuery(document).ready(function () {
    ...
    var cache = {}, lastXhr;
    jQuery("#" + wpseoMetaboxL10n.field_prefix + "focuskw").autocomplete({minLength: 3, formatResult: function (row) {
    ...
    jQuery(".yoast_help").qtip({position: {corner: {target: "topMiddle", tooltip: "bottomLeft"}}, show: {when: {event: "click"}}, hide: {when: {event: "click"}}, style: {tip: "bottomLeft", name: "blue"}});
    updateSnippet();
});
jQuery(document).ready(function ($) {
    ...
    $(".wpseo_image_upload_button").click(function (e) {
        ...
        wpseo_custom_uploader = wp.media.frames.file_frame = wp.media({title: wpseoMetaboxL10n.choose_image, button: {text: wpseoMetaboxL10n.choose_image}, multiple: false});
