	...
	public function getParameterData($type='filter') {
		...
		switch($type){
			case 'filter':
				...
				$param_data['page']['message'] = array("When a multi select list is presented, the custom value field will accept a comma separed list of values.",
													   ...
													   "The Page Slug parameter will only accept one slug.");
				//existing pages ids that are going to be displayed on a select box
				$pages_data=get_posts(array('post_type'=>'page','post_status'=>'any'));
