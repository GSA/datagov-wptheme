<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #D211D1;background-color: #FF54FF;padding: 10px;margin-top:10px;margin-bottom:10px;-moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
...
/* PAGINATION CSS */
	...
	.themecolor{ background-color: #FF54FF;border: 1px solid #D211D1; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px;}
