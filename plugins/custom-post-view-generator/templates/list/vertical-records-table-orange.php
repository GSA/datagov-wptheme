<style type="text/css">
	/* TEMPLATE CSS */		
	.cpvg-record-div{ background-color: #FF9500; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	...
	.themecolor{ background-color:#FF9500; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
