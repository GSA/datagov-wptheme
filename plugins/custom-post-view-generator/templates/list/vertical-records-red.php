<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #AF0E0E;background-color: #EE1313;padding: 10px;margin-top:10px;margin-bottom:10px; -moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
...
/* PAGINATION CSS */
	...
	.themecolor{ background-color: #EE1313;border: 1px solid #AF0E0E; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px;}
