<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #CECE1C;background-color: #FFFF00;padding: 10px;margin-top:10px;margin-bottom:10px;-moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	...
	.themecolor{ background-color: #FFFF00;border: 1px solid #CECE1C; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px;}
