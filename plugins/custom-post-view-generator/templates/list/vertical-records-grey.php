<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #7F7F7F;background-color: #BFBFBF;padding: 10px;margin-top:10px;margin-bottom:10px;-moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	...
	.themecolor{ background-color: #BFBFBF;border: 1px solid #7F7F7F; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px;}
