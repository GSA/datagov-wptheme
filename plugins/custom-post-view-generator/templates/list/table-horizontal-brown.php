<style type="text/css">
	/* TEMPLATE CSS */
	.cpvg-table{ margin-top:10px;border: 1px solid #684D0B; border-collapse: collapse; color: #4D4D4D; }
	.cpvg-table td { border: 1px solid #684D0B; padding: 2px;	}
	.cpvg-table th { border: 1px solid #684D0B; background-color: #AA7E15; color: #E5E5E5; padding: 2px; }
	.cpvg-table td ul { }
    ...
    table.cpvg-table thead tr .headerSortDown, table.cpvg-table thead tr .headerSortUp { background-color: #AA7E15; }	
</style>
