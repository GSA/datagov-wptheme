<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #008400;background-color: #44C744;padding: 10px;margin-top:10px;margin-bottom:10px;-moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	...
	.themecolor{ background-color: #44C744;border: 1px solid #008400; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px;}
