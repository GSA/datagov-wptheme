<style type="text/css">
	...
	.cpvg-table th { border: 1px solid #D211D1; background-color: #FF54FF; padding: 2px; color: #FFFFFF; width:30%;}
	.cpvg-table td ul { }
	...
	.pager div.short{ float: right;margin:0 0 122px 0;padding: 0;margin-right: 10px;width: 74px; }
