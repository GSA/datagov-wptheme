<style type="text/css">
	/* TEMPLATE CSS */
	.cpvg-table{ margin-top:10px;border: 1px solid #008400; border-collapse: collapse; }
	.cpvg-table td { border: 1px solid #008400; padding: 2px;	}
	.cpvg-table th { border: 1px solid #008400; background-color: #44C744; padding: 2px; }
	.cpvg-table td ul { }
	.cpvg-table .cpvg-table-blank{ border-left: 1px solid #FFFFFF; border-right: 1px solid #FFFFFF; }
	.cpvg-page{ border: 1px solid #008400; margin: 10px; }
	...
	.themecolor{ background-color: #44C744;border: 1px solid #008400; }
	.themecolor.normal{ background-color: #369736;color: White;border: solid 1px #008400; }
	.themecolor.active{ background-color: #2D622D;color: #BFBFBF;border: solid 1px #008400; }
	.pager.themecolor .btn{ height:27px; background-color: #369736;color: White;border: solid 1px #008400; }
    ...
    table.cpvg-table thead tr .headerSortDown, table.cpvg-table thead tr .headerSortUp { background-color: #44C744; }	
</style>
