<style type="text/css">
	/* TEMPLATE CSS */		
	.cpvg-record-div{ background-color: #FFFF00; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	.cpvg-record-div .cpvg-table{ border:0px; padding:5px; margin-top:5px; margin-bottom:8px; }    
	.cpvg-table td{ border:0px; color: #7F7F7F;}
	...
	.themecolor{ background-color:#FFFF00; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
