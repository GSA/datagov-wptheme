<style type="text/css">
	/* TEMPLATE CSS */		
	.cpvg-record-div{ background-color: #EE1313; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	...
	.themecolor{ background-color:#EE1313; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
