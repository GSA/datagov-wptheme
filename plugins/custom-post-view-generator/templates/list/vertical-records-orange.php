<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #FF6B00;background-color: #FF9500;padding: 10px;margin-top:10px;margin-bottom:10px;-moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	...
	.themecolor{ background-color: #FF9500;border: 1px solid #FF6B00;  -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px;}
