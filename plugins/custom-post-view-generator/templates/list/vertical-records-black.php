<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #BFBFBF; color: #EFEFEF; background-color: #1A1A1A;padding: 10px;margin-top:10px;margin-bottom:10px;  -moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	...
	.themecolor{ background-color: #1A1A1A;border: 1px solid #BFBFBF;color: #888888; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
