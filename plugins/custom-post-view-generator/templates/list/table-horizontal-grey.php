<style type="text/css">
	...
	.cpvg-table th { border: 1px solid #7F7F7F; background-color: #BFBFBF; padding: 2px; color: #FFFFFF; }
	.cpvg-table td ul { }
    ...
    table.cpvg-table thead tr .headerSortDown, table.cpvg-table thead tr .headerSortUp { background-color: #BFBFBF; }	
</style>
