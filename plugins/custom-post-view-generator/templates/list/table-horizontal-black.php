<style type="text/css">
	/* TEMPLATE CSS */
	.cpvg-table{ margin-top:10px; border: 1px solid #000000; border-collapse: collapse; padding: 2px; }
	.cpvg-table td { border: 1px solid #000000; padding: 2px;	}
	.cpvg-table th { border: 1px solid #000000; background-color: #000000; color: #E5E5E5; padding: 2px; }
	.cpvg-table td ul { }
	.cpvg-table .cpvg-table-blank{ border-left: 1px solid #FFFFFF; border-right: 1px solid #FFFFFF; }
	.cpvg-page{ border: 1px solid #000000; margin: 10px; }
	...
	.pager div.short{ float:right; margin:0 0 10px 0; padding:0; width:74px; }
	...
	.themecolor { background-color:#000000; border: 1px solid #000000; color:#FFFFFF; }
	.themecolor.normal{ }
	.themecolor.active{ background-color: #E5E5E5; color: #000000; }
	.pager.themecolor .btn{ background-color: #FFFFFF; height: 27px;  }
