<style type="text/css">
	/* TEMPLATE CSS */	
	.cpvg-record{border: 1px solid #8CACBB;background-color: #DEE7EC;padding: 10px;margin-top:10px;margin-bottom:10px;-moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px; }
	...
	.themecolor{background-color: #DEE7EC;border: 1px solid #8CACBB;margin-bottom: 3px; -moz-border-radius: 8px;  -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px;}
