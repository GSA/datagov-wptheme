<style type="text/css">
	/* TEMPLATE CSS */
	.cpvg-table{ margin-top:10px; border: 1px solid #FF6B00; border-collapse: collapse; }
	.cpvg-table td { border: 1px solid #FF6B00; padding: 2px;	}
	.cpvg-table th { border: 1px solid #FF6B00; background-color: #FF9500; padding: 2px; color: #F5F5F5; }
	.cpvg-table td ul { }
	.cpvg-table .cpvg-table-blank{ border-left: 1px solid #FFFFFF; border-right: 1px solid #FFFFFF; }
	.cpvg-page{ border: 1px solid #FF6B00; margin: 10px; }
	...
	.themecolor{ background-color: #FF9500;border: 1px solid #FF6B00; }
	.themecolor.normal{ background-color: #FF7400;color: White;border: solid 1px #FF6B00; }
	.themecolor.active{ background-color: #FF5500;color: White;border: solid 1px #FF6B00; }
	.pager.themecolor .btn{ height:26px; background-color: #FF7400;color: White;border: solid 1px #FF6B00; }
    ...
    table.cpvg-table thead tr .headerSortDown, table.cpvg-table thead tr .headerSortUp { background-color: #FF9500; }	
</style>
